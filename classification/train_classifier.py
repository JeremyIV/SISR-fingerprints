...
parser = argparse.ArgumentParser(description="Train an image classifier based on the configuration options in the given file.")
parser.add_argument(
	"-opt",
	required=True,
	type=Path)
...
classifier_name = classifiers.train_and_save_classifier(classifier_opt, training_dataset)
